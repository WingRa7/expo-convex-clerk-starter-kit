...
Create a `gt.config.json` file in the root of your project. You can get your Project ID from the [GT Dashboard](https://www.generaltranslation.com/dashboard).

```json
{
  "projectId": "your-project-id-from-gt-dashboard",
  "defaultLocale": "en",
  "locales": [
    "es",
    "fr",
...
> **Note:** The `_versionId` field you may see in existing configs is auto-generated by the GT CLI the first time you run `npx gtx-cli push`. You don't need to add it manually — it will be written to your `gt.config.json` after your first push.
